...
@section('content')
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                <form method="post" action="{{route('app.admin.fees.store')}}">
                    @csrf
                    @method('post')
                <div class="card-header">
                    <h3 class="card-title">New Fees</h3>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" name="amountbalance" class="form-control" 
